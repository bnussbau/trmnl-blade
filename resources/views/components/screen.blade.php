...
<head>
    ...
    @else
          <link rel="stylesheet"
              href="https://usetrmnl.com/css/{{ config('trmnl-blade.framework_version', '2.0.0') }}/plugins.css">
    @endif
    @if (config('trmnl-blade.framework_js_url'))
        <script src="{{ config('trmnl-blade.framework_js_url') }}"></script>
    @else
        <script src="https://usetrmnl.com/js/{{ config('trmnl-blade.framework_version', '2.0.0') }}/plugins.js"></script>
    @endif
