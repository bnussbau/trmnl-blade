...
<head>
    ...
    @else
          <link rel="stylesheet"
              href="https://trmnl.com/css/{{ config('trmnl-blade.framework_css_version') ?? config('trmnl-blade.framework_version', '3.1.1') }}/plugins.css">
    @endif
    @if (config('trmnl-blade.framework_js_url'))
        <script src="{{ config('trmnl-blade.framework_js_url') }}"></script>
    @else
        <script src="https://trmnl.com/js/{{ config('trmnl-blade.framework_js_version') ?? config('trmnl-blade.framework_version', '3.1.1') }}/plugins.js"></script>
    @endif
